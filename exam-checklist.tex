...
\begin{document}
    ...
    \begin{QandA}
        ...
        \begin{answered}
            Ein Problem wird z.B. auf ein bekanntes NP-komplettes Problem reduziert, um zu beweisen, dass das Problem ebenfalls NP-komplett und somit von einer nichtdeterministischen Turing-Maschine in polynomieller Zeit entschieden werden kann bzw. von einer Turing-Maschine in polynomieller Zeit verifiziert werden kann.
        \end{answered}
        \item Erklären Sie eine Standardtechnik, mit der man nachweisen kann, dass ein Problem nicht entscheidbar ist.
        \begin{answered}
            Reduktion auf ein nicht entscheidbares Problem.
        \end{answered}
        ...
        \begin{answered}
            Nein, da C nicht kontextfrei ist. Eine nicht kontextfreie Sprache kann nicht in eine kontextfreie übersetzt werden.
        \end{answered}
    \end{QandA}
\end{document}