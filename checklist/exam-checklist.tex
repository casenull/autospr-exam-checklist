...
\begin{document}
    ...
    \begin{description}
        ...
        \item[erzeugte Sprache einer Grammatik] Alle wörter, die aus einer Grammatik abgeleitet werden können.
        ...
        \item[Akzeptanzproblem] Es kann nicht entschieden werden, ob:
            \[A_{DEA}=\{\langle A,w \rangle | A \textnormal{ ein DEA, der } w \textnormal{ akzeptiert.}\}\]
    ...
    \begin{QandA}
        ...
        \begin{answered}
            \begin{enumerate}
                \item Annehmen, dass die Sprache $L$ regulär ist.
        ...
        \begin{answered}
            Die Sprache muss kontextfrei sein.
        \end{answered}
        ...
        \end{answered}
        \item Beschreiben Sie die fünf typischen Schritte, die notwendig sind, um mit dem Pumping Lemma zu beweisen, dass eine Sprache nicht kontextfrei ist.
        \begin{answered}
            \begin{enumerate}
                \item Annehmen, dass die Sprache $L$ kontextfrei ist.
                \item Es gibt eine Pumping Length $N$.
                \item Ein Wort $w \in L$ mit $|w| \geq N$ Festlegen.
                \item Wort aufteilen $w=uvxyz, |vxy| \leq N, |vy| > 0$.
                \item Was passiert, wenn $v$ und $y$ gepumpt werden? Ist das neue wort immer noch in der Sprache?
                \item Widerspruch und Schlussfolgerung.
            \end{enumerate}
        \end{answered}
        ...
        \begin{answered}
            Das Wort $w$ ist in der Sprache, die von der Turingmaschine M entschieden wird.
        \end{answered}
        ...
        \begin{answered}
            Ein Problem wird z.B. auf ein bekanntes NP-vollständiges Problem reduziert, um zu beweisen, dass das Problem ebenfalls NP-vollständig und somit von einer nichtdeterministischen Turing-Maschine in polynomieller Zeit entschieden werden kann bzw. von einer Turing-Maschine in polynomieller Zeit verifiziert werden kann.
        \end{answered}
        \item Erklären Sie eine Standardtechnik, mit der man nachweisen kann, dass ein Problem nicht entscheidbar ist.
        \begin{answered}
            Reduktion auf ein nicht entscheidbares Problem oder die Anwendung des Satzes von Rice.
        \end{answered}
        ...
        \begin{answered}
            ...
            $A$ und $B$ sind entscheidbar und $A$ soll auf $B$ reduziert werden. Die Abbildung
            \[f : \begin{cases} 
                \Sigma^* \to \Sigma^* \\
                w \mapsto f(w)
            \end{cases}\]
            heisst \textbf{polynomielle Reduktion von $A$ auf $B$} mit $w \in A \equiv f(w) \in B$ und $f(w)$ in polynomieller Zeit in $|w|$ berechenbar. $A \leq_p B$ heisst "$A$ ist polynomiell leichter entscheidbar als $B$". So können Aussagen über die Entscheidbarkeit getätigt werden: Ist $B$ entscheidbar, so muss auch $A$ entscheidbar sein. Ist $A$ nicht entscheidbar, so darf auch $B$ nicht entscheidbar sein.
        \end{answered}
        ...
        \begin{answered}
            Die division kann von einer deterministischen Turing-Maschine in polynomieller Zeit entschieden werden, SAT nicht.
        \end{answered}
